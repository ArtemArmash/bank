...
public:
    ...
    void SaveReportToFile(const string& filename, vector<Transaction> transactions) {
        ...
        if (fout.is_open()) {
            ...
            fout.close();
            cout << "Report saved to " << filename << " successfully." << endl;
        }
        else {
...
int main() {
    ...
    do {
        ...
        cout << "\t\t\t12. Save Report for Wallet\n";
        cout << "\t\t\t13. Exit\n\n\n\n";
        ...
        case 12: {
            ...
            if (walletIndex >= 0 && walletIndex < fin_man.wallets.size()) {
                ...
                cin >> filename;
                fin_man.wallets[walletIndex].SaveReportToFile(filename, fin_man.wallets[walletIndex].getTrans());
